...
class ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'render a list of products filtered by min_price and max_price' do
    ...
    assert_select '.title', 'Game Boy Color |'
  end
  ...
  test 'sort products by expensive prices first' do
    ...
    assert_response :success
    assert_select '.product', 12
    assert_select '.products .product:first-child .title', 'Seat Panda clásico |'
  end
  ...
  test 'sort products by cheapest prices first' do
    ...
    assert_response :success
    assert_select '.product', 12
    assert_select '.products .product:first-child .title', 'El hobbit |'
  end
  ...
  test 'render a detailed product page' do
    ...
    assert_response :success
    assert_select '.title', 'Title: PS4 Fat'
    assert_select '.description', 'Description: PS4 en buen estado'
    assert_select '.price', 'Price: 150'
  end
